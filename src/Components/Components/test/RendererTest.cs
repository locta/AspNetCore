...
namespace Microsoft.AspNetCore.Components.Test
{
    public class RendererTest
    {
        ...
        public async Task CanDispatchEventsToTopLevelComponents()
        {
            ...
            Assert.Equal(TaskStatus.RanToCompletion, task.Status); // Completes synchronously
        ...
        [Fact]
        public async Task DispatchEventAsync_SynchronousCompletion()
        {
            // Arrange
            var renderer = new TestRenderer();
            var parentComponent = new OuterEventComponent();
        ...
        // TODO update this once error handling is merged
        [Fact]
        public async Task DispatchEventAsync_SynchronousCancellation()
        {
            // Arrange
            var renderer = new TestRenderer();
            var parentComponent = new OuterEventComponent();
        ...
        // TODO update this once error handling is merged
        [Fact]
        public async Task DispatchEventAsync_SynchronousException()
        {
            // Arrange
            var renderer = new TestRenderer();
            var parentComponent = new OuterEventComponent();
        ...
        [Fact]
        public async Task DispatchEventAsync_AsynchronousCompletion()
        {
            // Arrange
            var tcs = new TaskCompletionSource<object>();
        ...
        // TODO update this once error handling is merged
        [Fact]
        public async Task DispatchEventAsync_AsynchronousCancellation()
        {
            // Arrange
            var tcs = new TaskCompletionSource<object>();
        ...
        // TODO update this once error handling is merged
        [Fact]
        public async Task DispatchEventAsync_AsynchronousException()
        {
            // Arrange
            var tcs = new TaskCompletionSource<object>();
        ...
        public async Task DisposesEventHandlersWhenAttributeValueChanged()
        {
            ...
            await renderer.DispatchEventAsync(origEventHandlerId + 1, args: null);
        ...
        public async Task CanCombineBindAndConditionalAttribute()
        {
            ...
            await renderer.DispatchEventAsync(checkboxChangeEventHandlerId, eventArgs);
        ...
        public async Task CanTriggerEventHandlerDisposedInEarlierPendingBatchAsync()
        {
            ...
            _ = renderer.DispatchEventAsync(eventHandlerId, new UIEventArgs());
        ...
        private class EventComponent : AutoRenderComponent, IComponent, IHandleStateChange
        {
            [Parameter]
        ...
        private class RendersSelfAfterEventComponent : IComponent, IHandleStateChange
        {
            [Parameter]
        ...
        private class BindPlusConditionalAttributeComponent : AutoRenderComponent, IHandleStateChange
        {
